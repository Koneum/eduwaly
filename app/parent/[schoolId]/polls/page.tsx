...
export default function ParentPollsPage() {
    ...
    <div className="p-4 md:p-6 lg:p-8 space-y-6">
      ...
      <div>
        ...
        <p className="text-responsive-sm text-muted-foreground mt-2">
          Participez aux sondages de l&apos;établissement de vos enfants
        </p>
      </div>
        ...
        <Card className="p-12">
          <div className="flex flex-col items-center justify-center text-center">
            ...
            <p className="text-sm text-muted-foreground">
              Les sondages destinés aux parents apparaîtront ici
            </p>
          </div>
        </Card>
      ) : (
          ...
          {polls.map((poll) => {
            ...
            return (
              <Card key={poll.id} className="overflow-hidden">
                <CardHeader className="bg-gradient-to-r from-blue-500/10 to-blue-500/5 dark:from-blue-500/20 dark:to-blue-500/10">
