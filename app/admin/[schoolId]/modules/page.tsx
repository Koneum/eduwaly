      ...
      <CardContent className="pt-6">
        <div className="flex flex-col gap-2">
          <div className="flex items-center justify-between">
            ...
            <Badge variant={module.isUeCommune ? "secondary" : "default"}>
              {module.isUeCommune 
                ? "UE Commune" 
  ...
  return (
    <div className="p-6">
      <div className="flex justify-between items-center mb-6">
        <h1 className="text-3xl font-bold text-foreground">{currentLabels.title}</h1>
        <PermissionButton
          category="modules"
          action="create"
        ...
        <Dialog open={showModal} onOpenChange={setShowModal}>
          <DialogContent>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div>
                <Label htmlFor="nom">{currentLabels.name} *</Label>
                <Input
                  id="nom"
                  name="nom"
                  value={formData.nom}
              ...
              <div>
                <Label htmlFor="vh">Volume horaire (heures) *</Label>
                <Input
                  id="vh"
                  name="vh"
                  type="number"
              ...
              <div className="flex items-center space-x-2">
                ...
                />
                <Label htmlFor="isUeCommune" className="cursor-pointer">
              ...
              {!formData.isUeCommune && (
                <div>
                  <Label htmlFor="filiereId">{currentLabels.filiereOptional}</Label>
                  <Select
