# Création des types TypeScript pour le système de Reporting
...
Set-Content -Path "$root\types\reporting.ts" -Value $content
Write-Host "✅ types/reporting.ts créé" -ForegroundColor Green
